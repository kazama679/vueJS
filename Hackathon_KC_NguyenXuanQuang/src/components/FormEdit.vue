      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-group">
          ...
          <input
            ...
            class="form-control"
          />
          <p v-if="err4" class="err">
            Số lượng tối thiểu là 1 và tối đa là 100
          </p>
        </div>

        <div class="form-actions">
          <button @click="handleClose" type="button" class="btn btn-close">
            Close
          </button>
...
const emit = defineEmits(["onCloseEdit", "onEditProduct"]);
